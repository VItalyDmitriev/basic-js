  ...
  for (let i = 0; i < matrix.length; i++) {
    for (let j = 0; j < matrix[i].length; j++) {
      ...
      if (matrix[i][j] === true) {
        ...
        if (i + 1 < matrix[i].length && matrix[i + 1][j] !== true) {
          matrix[i + 1][j] += 1;
        }
        ...
        if (i + 1 < matrix[i].length && j + 1 < matrix[i].length && matrix[i + 1][j + 1] !== true) {
          matrix[i + 1][j + 1] += 1;
        }
        if (i - 1 >= 0 && j + 1 < matrix[i].length && matrix[i - 1][j + 1] !== true) {
          matrix[i - 1][j + 1] += 1;
        }
        if (i + 1 < matrix[i].length && j - 1 >= 0 && matrix[i - 1][j + 1] !== true) {
          matrix[i + 1][j - 1] += 1;
        }
      }
    }
